...
public class BoosterImplTest {
  ...
  public void testBoosterBasic() throws XGBoostError, IOException {
    ...
    DMatrix trainMat = new DMatrix("/root/mc2/code/mc2-xgboost/demo/data/agaricus.txt.train");
    DMatrix testMat = new DMatrix("/root/mc2/code/mc2-xgboost/demo/data/agaricus.txt.test");
